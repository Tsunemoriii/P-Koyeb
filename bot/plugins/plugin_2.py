...
from bot import C2 as cli
from bot.plugins import help_text_2 as help_text, start_text_2 as start_text
from bot.utils.config import (
    AUTH_USERS,
    SHORTENER_API_2 as SHORTENER_API,
    SHORTENER_WEB_2 as SHORTENER_WEB,
)
...
async def _(bot, cmd):
    await check_user(bot, cmd, bot_id)
...
async def send_msg(user_id, message, broadcast_id, copy):
    try:
        ...
        return await send_msg(user_id, message, broadcast_id, copy)
